...
void tphoto_selector::pre_show(CVideo& /*video*/, twindow& window)
{
	...
	treport& navigation = find_widget<treport>(&window, "navigation", false);
...
void tphoto_selector::post_show(twindow& window)
{
	load_thread_running_ = false;
