...
tprogress::tprogress(const std::string& message, const boost::function<bool (tprogress_&)>& did_first_drawn, bool quantify, int hidden_ms, bool show_cancel)
	: message_(message)
...
bool run_with_progress(display& disp, const std::string& message, const boost::function<bool (tprogress_&)>& did_first_drawn, bool quantify, int hidden_ms, bool show_cancel)
{
	gui2::tprogress dlg(message, did_first_drawn, quantify, hidden_ms, show_cancel);
	dlg.show(disp.video());
