...
void ttools::pre_show(CVideo& /*video*/, twindow& window)
{
	window.set_label("misc/white-background.png");

	treport* navigation = find_widget<treport>(&window, "navigation", false, true);
...
void ttools::post_show(twindow& window)
{
}
