...
private:
	...
	bool enumerate_child(const boost::function<bool (const unit*, bool)>& did, const std::vector<unit*>& top_units, bool show_error) const;
	bool enumerate_child2(const boost::function<bool (const unit*, bool)>& did, const unit::tchild& child, bool show_error) const;
